...
class SplitInfo(val inputFormatClazz: Class[_],
  ...
  override def toString(): String = {
    ...
    ", hostLocation : " + hostLocation + ", path : " + path + ", length : " + length +
    ", underlyingSplit " + underlyingSplit
  }
  ...
  override def equals(other: Any): Boolean = other match {
    case that: SplitInfo =>
      this.hostLocation == that.hostLocation && this.inputFormatClazz == that.inputFormatClazz &&
