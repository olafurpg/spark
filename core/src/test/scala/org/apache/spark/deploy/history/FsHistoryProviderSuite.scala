  ...
  test("Parse application logs") {
    ...
    writeFile(newAppComplete,
              ...
              SparkListenerApplicationStart(
                  newAppComplete.getName(), Some("new-app-complete"), 1L, "test", None),
    ...
    writeFile(newAppCompressedComplete,
              ...
              None,
              SparkListenerApplicationStart(
                  newAppCompressedComplete.getName(), Some("new-complete-lzf"), 1L, "test", None),
    ...
    writeFile(newAppIncomplete,
              ...
              None,
              SparkListenerApplicationStart(
                  newAppIncomplete.getName(), Some("new-incomplete"), 1L, "test", None))
    ...
    updateAndCheck(provider) { list =>
      ...
      def makeAppInfo(id: String,
        ...
        ApplicationHistoryInfo(
            id, name, List(ApplicationAttemptInfo(None, start, end, lastMod, user, completed)))
      }
