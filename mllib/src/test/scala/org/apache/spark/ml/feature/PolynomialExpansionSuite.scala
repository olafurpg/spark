...
class PolynomialExpansionSuite
  ...
  test("Polynomial expansion with default parameter") {
    ...
    val polynomialExpansion =
      new PolynomialExpansion().setInputCol("features").setOutputCol("polyFeatures")
  ...
  test("Polynomial expansion with degree 1 is identity on vectors") {
    ...
    val polynomialExpansion =
      new PolynomialExpansion().setInputCol("features").setOutputCol("polyFeatures").setDegree(1)
  ...
  test("read/write") {
    val t =
      new PolynomialExpansion().setInputCol("myInputCol").setOutputCol("myOutputCol").setDegree(3)
