 ...
 */
@ExpressionDescription(usage = "a _FUNC_ b - Bitwise AND.", extended = "> SELECT 3 _FUNC_ 5; 1")
 ...
 * Code generation inherited from BinaryArithmetic.
 */
@ExpressionDescription(usage = "a _FUNC_ b - Bitwise OR.", extended = "> SELECT 3 _FUNC_ 5; 7")
...
@ExpressionDescription(
    usage = "a _FUNC_ b - Bitwise exclusive OR.", extended = "> SELECT 3 _FUNC_ 5; 2")
 ...
 */
@ExpressionDescription(usage = "_FUNC_ b - Bitwise NOT.", extended = "> SELECT _FUNC_ 0; -1")
