 ...
 */
private final class ShuffledRowRDDPartition(val postShufflePartitionIndex: Int,
 ...
 */
class ShuffledRowRDD(var dependency: ShuffleDependency[Int, InternalRow, InternalRow],
