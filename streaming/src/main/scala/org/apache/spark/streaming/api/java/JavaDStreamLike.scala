...
trait JavaDStreamLike[T, This <: JavaDStreamLike[T, This, R], R <: JavaRDDLike[T, R]]
  ...
  def countByValueAndWindow(
      windowDuration: Duration, slideDuration: Duration): JavaPairDStream[T, jl.Long] = {
  ...
  def mapPartitionsToPair[K2, V2](
      f: PairFlatMapFunction[java.util.Iterator[T], K2, V2]): JavaPairDStream[K2, V2] = {
   ...
   */
  def transformToPair[K2, V2](
      transformFunc: JFunction2[R, Time, JavaPairRDD[K2, V2]]): JavaPairDStream[K2, V2] = {
    implicit val cmk: ClassTag[K2] = fakeClassTag
    implicit val cmv: ClassTag[V2] = fakeClassTag
