...
class JavaStreamingListenerWrapperSuite extends SparkFunSuite {
  ...
  test("basic") {
    ...
    val batchSubmitted = StreamingListenerBatchSubmitted(
        BatchInfo(
            ...
            None,
            None,
            outputOperationInfos = Map(0 -> OutputOperationInfo(batchTime = Time(1000L),
                                                                id = 0,
                                                                name = "op1",
  ...
  private def assertOutputOperationInfo(javaOutputOperationInfo: JavaOutputOperationInfo,
